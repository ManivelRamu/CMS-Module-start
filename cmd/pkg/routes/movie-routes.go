...
var RegisterMovieRoutes = func(router *mux.Router) {
	...
	router.HandleFunc("/season/", controllers.Getseason).Methods("GET")
	router.HandleFunc("/season/{seasonId}", controllers.GetseasonById).Methods("GET")
	...
	router.HandleFunc("/episode/", controllers.Getepisode).Methods("GET")
	router.HandleFunc("/episode/{episodeId}", controllers.GetepisodeById).Methods("GET")
